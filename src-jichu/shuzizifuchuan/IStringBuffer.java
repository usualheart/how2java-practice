...
public interface IStringBuffer {
	    ...
	    public void insert(int pos,char b) throws IndexIsNagetiveException; //指定位置插入字符
	    public void insert(int pos,String b) throws IndexIsNagetiveException; //指定位置插入字符串
